...
my @xmlmain = ( @xmlmainskip, qw(log_limit) );
my @xmldevice = qw(name mac codecs enabled send_metadata send_coverart player_volume idle_timeout read_ahead encryption server volume_feedback volume_mode volume_mapping mute_on_pause alac_encode volume_trigger prevent_playback);
